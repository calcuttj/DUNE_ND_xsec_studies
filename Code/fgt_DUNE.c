...
void fgt_efficiencies(char * fInFileName, char * fEffFileName, char * fOutFileName){
...
//        cout<<j<<endl;
        ...
        for(int k = 0; k < array_pmu->GetEntries(); k++){
           ...
           if(i < 2){//FD FHC,RHC
             ...
             int eff_bin = trkeff_muon->FindBin(P/1.e3);
             double eff = trkeff_muon->GetBinContent(eff_bin)*pideff_muon->GetBinContent(eff_bin);
        ...
        for(int k = 0; k < array_pprot->GetEntries(); k++){
           ...
           if(i < 2){//FD FHC,RHC
             ...
             int eff_bin = trkeff_proton->FindBin(P/1.e3);
             double eff = trkeff_proton->GetBinContent(eff_bin)*pideff_proton->GetBinContent(eff_bin);
        ...
        for(int k = 0; k < array_ppip->GetEntries(); k++){
           ...
           if(i < 2){//FD FHC,RHC
             ...
             int eff_bin = trkeff_pion->FindBin(P/1.e3);
